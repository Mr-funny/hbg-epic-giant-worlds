...
<p align="center">
  <strong>万物皆可巨构：</strong>把国家、宗教、人物、动物、动作、日常物件或抽象概念<br />
  转义成<strong>概念不可能、材质与光影写实、可以被人类穿行和居住的世界级巨构</strong>，<br />
...
| 常见问题 | Skill 的处理方式 |
|---|---|
| 输入只有“泰国”“印度教”“弹琴”或“一把伞” | 不只是补齐场景，而是让关键词本身变成地貌、城市、天穹、天气或物理法则 |
| 画面很宏伟，却像真实旅游纪录片 | 启用现实拒绝门：寺庙加火山、海门加宫殿、村落加大屋顶都不能直接过关 |
| 只是把普通物体放大 | 强制两类事物融合、一个不可能法则、两项环境后果、三条尺度证据和人类居住关系 |
...
核心是“万物皆可巨构”，不要生成现实中可能存在的寺庙、火山、海门或村落旅游景观。
先给我四种不同的巨构转义：人体成为山城、动物成为天穹、工艺成为地质、动作成为天气。
每个方案必须有两类事物融合、一个不可能法则、两项环境后果、人类居住关系和三条尺度证据。
四张都要是16:9超广角，但分别使用贴地低机位、平视、斜俯视和高空鸟瞰。
...
| 万物巨构转义 | 人体变山城、器物变基础设施、动物变天穹、工艺变地质、动作变物理法则 |
| 现实拒绝门 | 排除普通寺庙、火山、海门、村落、浮空宫殿和单纯放大物体 |
| 荒诞度验收 | 关键词转义、类别碰撞、不可能法则、人类栖居、尺度证据五项至少 8/10 |
| 文化扩写 | 在荒诞巨构成立后，再补充地貌、建筑、工艺、纹样、人物行为、精神内核与禁忌 |
| 巨物构图 | 巨构控制画面、微小人物、人类设施附着、三条尺度证据、负空间和尺度锚点 |
...
这里的“写实”只负责材质、光线、空气、水流和透视可信，不负责让概念回到现实。真正通过门槛的画面应该像：山岳尺度的面孔本身就是城市，桥梁穿过眼眶；巨兽腹部成为由神殿柱群托起的天空；云海被柱廊支撑并从边缘落成瀑布。普通寺庙配火山、海边石门或夸张屋顶，只算宏伟风景，不算荒诞巨构。
